    ...
    public class Plugin : BaseUnityPlugin {
        ...
        private void Awake() {
            ...
            var ExampleEnemyLevelRarities = new Dictionary<Levels.LevelTypes, int> {
                {Levels.LevelTypes.ExperimentationLevel, 30},
                //{Levels.LevelTypes.AssuranceLevel, 40},
                {Levels.LevelTypes.VowLevel, 80},
                //{Levels.LevelTypes.OffenseLevel, 100},
                {Levels.LevelTypes.MarchLevel, 70},
                {Levels.LevelTypes.RendLevel, 60},
                //{Levels.LevelTypes.DineLevel, 200},
                {Levels.LevelTypes.TitanLevel, 45},
